          ...
          <ul className='flex flex-wrap justify-center items-center text-xl lg:text-2xl overflow-hidden'>
            {
              projects.map((project, index) => (
                <li key={index} className='w-full lg:w-1/2 xl:w-1/2 px-4 mb-8 h-full'>
                  <ProjectCard imageUrl={project.imageUrl} projectLink={project.projectLink} description={project.description} title={project.title}/>
                </li>
              ))
            }
          </ul>
      ...
      <section id="contact" className='py-8 w-full text-center'>
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='flex flex-row justify-between'>
            <Link  className="px-4" href={"https://github.com/Zhengda-Huang?tab=repositories"} target="_blank">
              <Image
                src="/icons/git.jpeg"
                width={75}
                height={20}
